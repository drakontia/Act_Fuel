<h2>Listing <span class='muted'>Attacktype_tables</span></h2>
<br>
<?php if ($attacktype_tables): ?>
...
<?php foreach ($attacktype_tables as $item): ?>		<tr>
			...
			<td>
				<div class="btn-toolbar">
					<div class="btn-group">
						<?php echo Html::anchor('attacktype/table/view/'.$item->id, '<i class="icon-eye-open"></i> View', array('class' => 'btn btn-small')); ?>						<?php echo Html::anchor('attacktype/table/edit/'.$item->id, '<i class="icon-wrench"></i> Edit', array('class' => 'btn btn-small')); ?>						<?php echo Html::anchor('attacktype/table/delete/'.$item->id, '<i class="icon-trash icon-white"></i> Delete', array('class' => 'btn btn-small btn-danger', 'onclick' => "return confirm('Are you sure?')")); ?>					</div>
				</div>
...
<?php else: ?>
<p>No Attacktype_tables.</p>

<?php endif; ?><p>
	<?php echo Html::anchor('attacktype/table/create', 'Add new Attacktype table', array('class' => 'btn btn-success')); ?>
