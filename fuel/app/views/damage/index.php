...
<div class="form-group">
    ...
    <div class="col-sm-4">
        <?php echo Form::select('job', null, $joblist,  array('class' => 'form-control')); ?>
    </div>
...
<div class="form-group">
    ...
    <div class="col-sm-4">
        <?php echo Form::select('attackmode', null, $attackmode,  array('class' => 'form-control')); ?>
    </div>
...
<div class="form-group">
    ...
    <?php echo Form::label('クリティカル発動力アップ', 'criticalup', array('class' => 'col-sm-2 control-label')); ?>
    <div class="col-sm-4">
...
<div class="form-group">
    <div class="col-sm-offset-2 col-sm-10">
        <?php echo Form::button('fire', '出力', array('class' => 'btn btn-primary', 'id' => 'fire')); ?>
    </div>
</div>
...
<div class="form-group">
    ...
    <div class="col-sm-3">
        <?php echo Form::input('wsdmg', 0, array('none' => 'none'), array('class' => 'form-control')); ?>
    </div>
</div>
<div class="form-group">
    ...
    <div class="col-sm-3">
        <?php echo Form::input('gcd', 0, array('none' => 'none'), array('class' => 'form-control')); ?>
    </div>
</div>
<div class="form-group">
